...
<div class="container">
  ...
  <div class="form-row">
    <div class="col-md-2">
	    <label for="mbsp_email">이름</label>
	</div>
	<div class="col-md-10">
	    <input type="text" style="width: 500px" id="mbsp_name" name="mbsp_name" value="${sessionScope.loginStatus.mbsp_name}" readonly>
	</div>
	<div class="col-md-2">
	    <label for="mbsp_email">이메일</label>
	</div>
	<div class="col-md-10">
	    <input type="text" style="width: 500px" id="mbsp_email" name="mbsp_email" value="${sessionScope.loginStatus.mbsp_email}">
	    
	</div>
	<div class="col-md-2">
	    <label for="mbsp_email">연락처</label>
	</div>
	<div class="col-md-10">
	    <input type="text" style="width: 500px" id="mbsp_phone" name="mbsp_phone" value="${sessionScope.loginStatus.mbsp_phone}">
	</div>
	<div class="col-md-2">
	    <label for="mbsp_email">주소</label>
	</div>
	<div class="col-md-10">
	    <input type="text" style="width: 250px" id="mbsp_addr" name="mbsp_addr" value="${sessionScope.loginStatus.mbsp_addr}"> -
	    <input type="text" style="width: 250px" id="mbsp_deaddr" name="mbsp_deaddr" value="${sessionScope.loginStatus.mbsp_deaddr}">
	        우편번호
	    <input type="text" style="width: 250px" id="mbsp_zipcode" name="mbsp_zipcode" value="${sessionScope.loginStatus.mbsp_zipcode}">
	</div>
  </div>
  <br><br><br>
  <h5>배송 정보</h5>
  ...
  <div class="form-row">
	...
	<div class="col-md-2">
	    <label for="mbsp_email">배송메세지<br>(100자내외)</label>
	</div>
	<div class="col-md-10">
